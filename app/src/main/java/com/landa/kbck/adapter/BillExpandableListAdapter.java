...
public class BillExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public BillExpandableListAdapter(ArrayList<String> gData, ArrayList<ArrayList<String>> iData, Context mContext) {
        this.gData = gData;
        this.iData = iData;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.item_bill_group, parent, false);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.item_bill_child, parent, false);
