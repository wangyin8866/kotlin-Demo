...
class UpdateService2 : Service() {

    private var update_version_id by PreferenceLocal(Constant.KEY_VERSION_ID, 0L)
    private var isDownVersionFinish: Boolean by PreferenceLocal(Constant.KEY_VERSION_IS_FINISH, false)
    // app本地保存名
    ...
    private var downFinish: DownFinish? = null

    public fun setDownFinish(downFinish: DownFinish) {
    ...
    inner class MyBinder : Binder() {
        val service: UpdateService2
            get() = this@UpdateService2
    }
